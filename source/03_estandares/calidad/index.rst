...
**Para comenzar un proyecto:**
   ...
   2. Consultar :doc:`metricas_traduccion` para conocer rangos
   3. Usar :doc:`checklist_revision` durante todo el proceso

**Durante la traducción:**
   - Referencia constante a :doc:`checklist_revision`
   - Verificar enriquecimiento contra :doc:`metricas_traduccion`

**Al finalizar:**
   - Evaluar contra :doc:`criterios_calidad`
