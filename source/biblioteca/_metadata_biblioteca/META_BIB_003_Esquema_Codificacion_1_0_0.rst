...
.. code-block:: text
   ...
   INF PRG FST 001    ❌ Espacios en lugar de puntos
   INF-PRG-FST-001    ❌ Guiones en lugar de puntos
...
✅ Existe demanda real (3+ libros potenciales)  
✅ No existe especialidad similar  
✅ Código de 3 letras disponible y nemotécnico  
✅ Tecnología/área con momentum sostenido  
✅ No puede clasificarse en especialidad existente  

**SE RECHAZA si:**

❌ Solo 1-2 libros potenciales  
❌ Ya existe especialidad que cubre el tema  
❌ Tecnología muy nicho o temporal  
❌ Código propuesto ya en uso  
❌ Puede usar especialidad GEN (General)  
