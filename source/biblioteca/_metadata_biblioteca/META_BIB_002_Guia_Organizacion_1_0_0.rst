...
.. code-block:: text
 ...
 Libro_Ejemplo/
 +-- metadata_libro.rst [STAR] OBLIGATORIO - Info bibliográfica
 +-- index.rst [STAR] OBLIGATORIO - Índice navegable
 +-- glosario_acumulativo.rst [STAR] OBLIGATORIO - Todos los términos

**Opcionales pero Recomendados:**

.. code-block:: text

 +-- README.md [WARNING] Información rápida del libro
 +-- LICENSE.txt [WARNING] Licencia de traducción
