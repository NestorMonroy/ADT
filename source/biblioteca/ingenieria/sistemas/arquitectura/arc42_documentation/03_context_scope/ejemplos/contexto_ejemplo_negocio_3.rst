...
* Se visualizan las **entradas y salidas** principales del sistema
* Se identifican tanto **usuarios humanos** como **entorno técnico**
* Se usa un **diagrama de flujo de datos** para representar el contexto
* El sistema se representa como **caja negra** con sus interfaces externas
