...
## [TABLE] DIFERENCIAS IDENTIFICADAS
...
## [TARGET] RESPUESTA A LA PREGUNTA
...
[OK] **Esta es una plantilla específica de arc42, NO está en archivos .md**

#### 2. Tips Individuales

**FUENTE:** [OK] **Archivos .md en `/original/`**
...
## [WARNING] IMPLICACIONES PARA TRADUCCIÓN

### LO QUE TRADUJE ESTÁ CORRECTO [OK]
...
|----------|-------------|---------------|
| Título | "Tip 7-1: Document..." | [OK] "Tip 7-1: ¡Documenta..." |
| Lista nodos | "nodes, i.e. processors..." | [OK] "nodos, es decir, procesadores..." |
| Lista relaciones | "relations (channels)..." | [OK] "relaciones (canales)..." |
| Imagen | `{{ site.imageurl }}/07-...` | [OK] `../figuras/07-...` |
| Sección Delegate | "### Delegate hardware..." | [OK] Sección presente |
| Contenido delegate | "Try to delegate..." | [OK] "Intenta delegar..." |

**TODO el contenido traducido [OK]**

---

## [DEBUG] VERIFICACIÓN CONTRA .md ORIGINAL

### Tips Verificados

**Todos los tips fueron traducidos desde archivos .md:**

[OK] Tip 7-1: 26 líneas .md -> Traducido completo
[OK] Tip 7-2: 21 líneas .md -> Traducido completo
[OK] Tip 7-3: 19 líneas .md -> Traducido completo
[OK] Tip 7-4: 14 líneas .md -> Traducido completo
[OK] Tip 7-5: 23 líneas .md -> Traducido completo
[OK] Tip 7-6: 15 líneas .md -> Traducido completo
[OK] Tip 7-7: 26 líneas .md -> Traducido completo
[OK] Tip 7-8: 18 líneas .md -> Traducido completo
[OK] Tip 7-9: 57 líneas .md -> Traducido completo
[OK] Tip 7-10: 21 líneas .md -> Traducido completo

### Ejemplos Verificados

[OK] TPU 1: 63 líneas .md -> Traducido completo
[OK] HTML SC: 41 líneas .md -> Traducido completo
[OK] TPU 2: 26 líneas .md -> Traducido completo
...
2. **Tips:** Archivos .md en `/original/` [OK]
3. **Ejemplos:** Archivos .md en `/original/` [OK]

### Estado de Traducción:

[OK] **TODO traducido correctamente desde fuentes .md**
[OK] **Archivo principal actualizado con plantilla completa**
[OK] **NO hay conflicto con docs.arc42.org** (es solo renderizado)
