...
2. HSC crea una **instancia** de ``AllChecksRunner``
3. Obtiene todos los archivos configurados en ``allFiles``
4. (Planeado) Obtiene todas las clases Checker disponibles basándose en anotaciones
5. Realiza las verificaciones, recolectando los resultados
