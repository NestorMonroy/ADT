...
La intención original de los **diagramas de secuencia** UML era mostrar interacciones entre **instancias** concretas de clases, con invocaciones de métodos y parámetros, - el nivel más bajo de detalle que puedes tener. En este nivel, hablamos de la **instancia** 'Homer Simpson' en lugar de la clase ``Person``.

Las ventajas de tales detalles son **exhaustividad y precisión**: Visualizas ejecuciones únicas de código fuente.
