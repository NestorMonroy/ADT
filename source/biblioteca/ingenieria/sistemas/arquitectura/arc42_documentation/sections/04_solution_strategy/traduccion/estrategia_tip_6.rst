...
Cuando el contexto cambia, entender el razonamiento original ayuda a decidir si la decisión sigue siendo válida.
...
**Justificación:** 
  * Requisito de escalabilidad horizontal para 100M usuarios
  * Esquema flexible necesario por evolución rápida del producto
  * Experiencia previa del equipo con MongoDB

**Decisión:** Implementar en Java

**Justificación:**
  * Ecosistema maduro y estable
  * Pool de desarrolladores disponibles
