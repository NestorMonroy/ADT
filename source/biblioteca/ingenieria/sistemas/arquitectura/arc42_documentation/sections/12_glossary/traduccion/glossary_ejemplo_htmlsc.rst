...
.. list-table::
   ...
   * - **Tamaño**
     - Compacto (5 términos) ✅
   * - **Especificidad**
     - Todos específicos del dominio de validación HTML ✅
   * - **Claridad**
     - Definiciones concisas (1 oración) ✅
   * - **Relaciones**
     - Términos se referencian entre sí (Link → LinkTarget) ✅
   * - **Audiencia**
...
.. note::
   ...
   * ✅ Glosario puede duplicarse en Sección 8 si términos son conceptos transversales
   * ✅ Domain Model en Sección 8 complementa glosario tabular
   * ✅ Ambas secciones trabajan juntas para definir lenguaje del sistema
