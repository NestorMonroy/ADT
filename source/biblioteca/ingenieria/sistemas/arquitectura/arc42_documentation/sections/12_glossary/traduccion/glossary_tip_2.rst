...
.. list-table::
   ...
   * - Términos técnicos genéricos
     - ⚠️ SOLO si usados de forma especial
...
1. **Orden Alfabético**
   ...
   * ✅ Facilita búsqueda rápida
   * ✅ Convención estándar

2. **Definiciones Concisas**
   
   * ✅ 1-3 oraciones por término
   * ✅ Evitar definiciones circulares
   * ❌ NO: "Cliente es un tipo de usuario"
   * ✅ SÍ: "Cliente es una persona u organización que compra productos"
