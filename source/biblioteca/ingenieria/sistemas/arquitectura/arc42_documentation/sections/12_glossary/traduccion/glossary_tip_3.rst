...
* ✅ Cada término en diagrama debe estar en tabla
* ✅ Cada término en tabla puede estar en diagrama (opcional)
...
.. list-table::
   ...
   * - Dominio complejo con muchas relaciones
     - ✅ **SÍ** - Diagrama ayuda mucho
   * - Dominio simple con <10 términos
     - ⚠️ **OPCIONAL** - Tabla puede ser suficiente
   * - Onboarding frecuente de nuevos
     - ✅ **SÍ** - Facilita aprendizaje
   * - Stakeholders visuales
     - ✅ **SÍ** - Prefieren diagramas a tablas
   * - Dominio muy técnico
     - ⚠️ **CUIDADO** - Puede intimidar a no-técnicos
...
.. warning::
   ...
   * 🔄 Revisar en cada sprint
   * 📝 Usar herramientas de diagramas-como-código (PlantUML, Mermaid)
   * 🔗 Automatizar generación desde modelo de datos si es posible
