...
.. list-table::
   ...
   * - ❌ Nadie actualiza el glosario
     - ✅ Glosario se mantiene actualizado
   * - ❌ "Alguien debería hacerlo"
     - ✅ Accountability clara
   * - ❌ Glosario se vuelve obsoleto
     - ✅ Revisión regular programada
   * - ❌ Inconsistencias no resueltas
     - ✅ Arbitraje de conflictos
   * - ❌ Nuevos términos no documentados
     - ✅ Proceso de adición definido
...
* ❌ Escribir TODAS las definiciones solo
* ❌ Ser experto en todos los términos
* ❌ Tomar decisiones unilaterales

**El Responsable SÍ debe:**

* ✅ **Coordinar** el proceso de actualización
* ✅ **Facilitar** consenso entre expertos
* ✅ **Asegurar** que glosario se mantenga
* ✅ **Delegar** definiciones a expertos apropiados
...
.. code-block:: text
   ...
   Calidad:
   ├─ Términos con >1 sinónimo: 5 ⚠️
   ├─ Términos sin ejemplo: 8 ⚠️
...
.. code-block:: text
   ...
   Esto significa:
   ✅ Sarah coordinará actualizaciones del glosario
   ✅ Si encuentras término nuevo → notifica a Sarah
   ✅ Si término necesita clarificación → pregunta a Sarah
   ✅ Sarah facilitará consenso en definiciones
