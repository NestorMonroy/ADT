...
Aquí tienes el **quality tree** (árbol de calidad) en la sección 10.1 como un resumen (a menudo gráfico), y los **escenarios de calidad** (sección 10.2) como una colección de muchos (o todos) los **requisitos de calidad** adicionales.
...
* Mantiene la sección 1.2 legible y enfocada
