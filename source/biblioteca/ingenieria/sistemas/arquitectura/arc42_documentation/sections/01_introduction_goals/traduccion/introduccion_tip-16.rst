.. meta::
 :layout: post
 :title: Consejo 1-16: ¡Describe solo los 3-5 atributos de calidad objetivo principales en la introducción!
...
Aunque debes cumplir con todos los atributos de calidad objetivo requeridos por
los stakeholders, debes mantener esta sección de la documentación breve.

Aquí, en la sección 1.2, describes solo un puñado (top 3-5) de estos requisitos.

Usa explicaciones breves con escenarios (ver :ref:`introduccion-tip-12`), no solo
palabras clave.
