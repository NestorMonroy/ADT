 ...
 * [ERROR] No pudimos probar durante miles de kilómetros
 * [ERROR] No pudimos simular todas las condiciones reales
 * [ERROR] Condiciones de persecución son impredecibles
 ...
 * [OK] Usar componentes "automotive-grade" certificados
 * [OK] Testing en cámara climática (-25°C a +85°C)
 * [OK] RAID 1 para redundancia de disco
 * [WARNING] Mounting anti-vibración (parcial)

2. **Software**

 * [OK] Establecer SLAs con proveedores de drivers
 * [OK] Mantener versiones de kernel LTS (Long Term Support)
 * [WARNING] Expertise interno limitado en kernel
 * [WARNING] Dependencia de drivers binarios (sin alternativa)

3. **Negocio**

 * [OK] Warranty disclaimer en contrato
