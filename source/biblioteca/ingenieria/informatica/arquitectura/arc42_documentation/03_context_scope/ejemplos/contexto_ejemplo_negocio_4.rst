...
* Se visualizan las **entradas y salidas** del sitio web
* Se identifican los **socios de comunicación** externos
* Se usa **drawio/diagrams.net** como herramienta de diagramación
* El sistema se representa como **caja negra** con interfaces externas claras
...
:Herramienta: drawio/diagrams.net
