...
**Importancia:**
   ...
   ❌ **Muy poco enriquecimiento** → Traducción literal sin valor agregado  
   ❌ **Demasiado enriquecimiento** → Divagación, pérdida de foco
...
.. code-block:: text
   ...
   1. ¿Cuántas líneas tiene el original?
      ...
      ├─ 20-50 líneas
      │  └─ Objetivo: +100% a +300%
      │     ├─ Agregar tip contextual ✅
      │     ├─ Agregar 1-2 ejemplos ✅
      │     └─ Mejorar formato ✅
      │
      ├─ 50-100 líneas
      │  └─ Objetivo: +80% a +150%
...
.. code-block:: text
   ...
   Correlación inversa verificada en 196 archivos ✅
