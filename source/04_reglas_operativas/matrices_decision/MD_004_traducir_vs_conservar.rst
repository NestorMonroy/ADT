...
**Importancia:**
   ...
   ❌ **Traducir término establecido** → Confusión, búsquedas fallidas  
   ❌ **Conservar término traducible** → Texto híbrido innecesario
...
.. code-block:: text
   ...
   - Discusión técnica: "Implementamos un Singleton" ✅ vs "Implementamos un Único" ❌
...
.. code-block:: text
   ...
   Ejemplos:
   ✅ "Metodología Agile" (nombre formal)
   ✅ "Desarrollo ágil" (adjetivo descriptivo)
...
.. code-block:: text
   ...
   Ejemplos:
   ✅ "Building Block View" → "Vista de Bloques de Construcción" (título formal)
   ✅ "Runtime View" → "Vista de Runtime" (término técnico + contexto)
   ✅ "Cross-cutting Concept" → "Concepto Transversal" (traducible)
...
.. code-block:: text
   ...
   Ratio: 54x → CONSERVAR "Stakeholder" ✅
...
.. code-block:: text
   ...
   RESULTADO: "5. Vista de Bloques de Construcción" ✅
...
.. code-block:: text
   ...
   bloques de construcción usando la metodología ATAM." ✅
...
.. code-block:: text
   ...
   Docstring:
   """Gestiona la configuración de la aplicación usando el patrón Singleton""" ✅
...
.. code-block:: text
   ...
   ❌ "El Maestro Melé revisa el Backlog del Producto"
...
.. code-block:: text
   ...
   ✅ "El Scrum Master revisa el Product Backlog"
...
.. code-block:: text
   ...
   ❌ "The quality requirements define the constraints for the system"
...
.. code-block:: text
   ...
   ✅ "Los requisitos de calidad definen las restricciones para el sistema"
...
.. code-block:: text
   ...
   ❌ 3 traducciones diferentes del mismo término
...
**Verificación:**
   ✅ Consistencia 100% en 196 archivos de arc42  
   ✅ 0 variaciones en términos clave  
