...
.. code-block:: text
   ...
   ⏳ prompt_tip_breve.rst (< 20 líneas)
   ⏳ prompt_seccion_corta.rst (20-50 líneas)
   ⏳ prompt_seccion_extensa.rst (> 100 líneas)

**Por tipo de contenido:**

.. code-block:: text

   ⏳ prompt_codigo_fuente.rst
   ⏳ prompt_tabla_datos.rst
   ⏳ prompt_diagrama.rst
...
.. code-block:: text
   ...
   ⚠️ Límites de contexto pueden ser menores
   ⚠️ Puede requerir dividir documento grande
   ✅ Bueno para traducciones iterativas
...
.. code-block:: text
   ...
   ⚠️ Pueden tener menor capacidad
   ⚠️ Requieren prompts más concisos
...
.. code-block:: text
   ...
   ✅ Pedir verificación al LLM
   ✅ Usar conversación para iteraciones
   ✅ Mantener contexto de decisiones previas
...
.. code-block:: text
   ...
   ❌ Omitir revisión humana
   ❌ Saltarse PASO 0 manual
   ❌ Ignorar checklists ADT
   ❌ No verificar terminología
   ❌ Usar prompts genéricos sin ADT
...
.. code-block:: text
   ...
   ✅ Traducción fluida del texto
   ✅ Mantener estructura general
   ✅ Generar ejemplos relevantes
   ✅ Convertir sintaxis (LaTeX→RST)
   ✅ Sugerir enriquecimientos
...
.. code-block:: text
   ...
   ❌ Inventar contenido no presente
   ❌ Omitir secciones sin avisar
   ❌ Terminología inconsistente
   ❌ Referencias rotas
   ❌ Números de línea incorrectos
