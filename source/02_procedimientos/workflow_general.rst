...
.. code-block:: text
 ...
 +- Crear inventario COMPLETO ([WARNING] con script)
 ...
 +- Comparar contra inventario ([WARNING] con script)
 | +- python3 /tmp/ADT/scripts/analisis_profundo_funcional.py XX
 ...
 [WARNING] AUTOMATIZACIÓN CON SCRIPT:
...
**Lección aprendida:**
 [WARNING] NO buscar archivos por palabras clave en nombres.
...
- [OK] Automatiza el conteo (ahorra 15-20 min)
- [OK] Detecta elementos especiales (imágenes, tablas)
- [OK] Genera estadísticas precisas
- [OK] Conteo 100% preciso
 ...
 **PERO:** Contenido textual es idéntico [OK]
...
.. code-block:: text
 ...
 [OK] IMÁGENES: 0
 [OK] TABLAS: 0
 [OK] BLOQUES DE CÓDIGO: 2
 [OK] ENLACES: 3 (internos)
 [OK] DIVS HTML: 1
 [OK] LISTAS BULLET: 4 items
...
1. **Verificar clasificación de archivos:**
 ...
 Front matter: category: requirements <- [WARNING] PROBLEMA
...
3. **Verificar enlaces internos:**
 ...
 Tip 2-3 -> referencia a tip 2-4 [OK]
 Tip 2-4 -> referencia a tip 2-3 [OK]
 ...
 **Ventajas de estructura 1:1:**
 ...
 [OK] Facilita mantenimiento
 [OK] Permite trabajar en archivos individuales
 [OK] Clara trazabilidad al original
 [OK] Mejor organización y navegación
 [OK] Compatible con toctree de Sphinx

 **NO crear:**

 [ERROR] Un solo archivo monolítico con todo el contenido
 [ERROR] Mezclar múltiples originales en un solo RST
...
[ERROR] **Traducción demasiado literal:**
...
.. code-block:: rst
 ...
 # [ERROR] INCORRECTO (demasiado literal)
 .. textbf::
 importante

 # [OK] CORRECTO (preserva función, adapta forma)
 **importante**

[ERROR] **Preservar elementos no semánticos:**
...
.. code-block:: rst
 ...
 # [ERROR] INCORRECTO (preserva espaciado literal)
 Párrafo 1
 ...
 # [OK] CORRECTO (omite elemento no semántico)
 Párrafo 1
...
.. code-block:: text
 ...
 SI SÍ: [OK] Signifié preservado -> Continuar
 SI NO: [WARNING] Revisar traducción -> Ajustar

 ¿La traducción usa sintaxis NATURAL de RST?

 SI SÍ: [OK] Signifiant adaptado -> Continuar
 SI NO: [WARNING] Demasiado literal -> Simplificar
...
.. code-block:: rst
 ...
 [OK] stakeholder (NO "interesado")
 [OK] quality goals (puede preservarse o traducir contextualmente)
 [OK] runtime (puede preservarse)
 [OK] deployment (puede preservarse)
 [OK] middleware (NO traducir)
 [OK] framework (NO traducir)
 [OK] pattern (puede preservarse como "patrón")
 [OK] refactoring (puede preservarse)
...
[ERROR] **ERROR:** No traducir COMPLETO el original PRIMERO, y en su lugar solo agregar contenido
...
3. **Detectar patrones comunes de literalidad:**
 ...
 [ERROR] "Debes hacer X" (literal de "You should do X")
 -> [OK] "Haz X" o "Hacer X" (imperativo directo)

 [ERROR] "puede ser explicado" (literal de "can be explained")
 -> [OK] "se explica" o "suele explicarse"

 [ERROR] Metadatos del formato original (:layout:, :permalink:)
 -> [OK] Eliminar (no son semánticos)

 [ERROR] Construcciones muy cercanas al original
 -> [OK] Naturalizar al español
 ...
 [ERROR] "los bloques de construcción principales"
 -> [OK] "los componentes arquitectónicos principales"

 [ERROR] "las partes interesadas del proyecto"
...
1. **total_traducciones vs total_originales:**
 ...
 ¿Son iguales? -> SI: [OK] todos los archivos existen
 NO: [ERROR] faltan archivos

2. **traducciones_faltantes:**

 .. code-block:: text

 Lista vacía [] -> [OK] No falta ningún archivo
 Lista con archivos -> [ERROR] Traducir archivos faltantes
...
- [OK] Automatiza verificación (ahorra 20-25 min)
- [OK] Detecta archivos faltantes
- [OK] Genera reporte estructurado
- [OK] Conteo 100% preciso
...
.. code-block:: text
 ...
 [OK] Todos los archivos de inventario existen
 [OK] Todos los archivos están completos
 [OK] Archivo principal tiene todas las secciones
 [OK] Archivo principal tiene todas las plantillas
 [OK] No hay secciones omitidas
 [OK] Longitud apropiada vs original
 [OK] Todos los elementos especiales traducidos
...
.. code-block:: text
 ...
 [OK] Archivo principal: 237 líneas (completo)
 [OK] Todos los tips: 10/10 completos
 [OK] Todos los ejemplos: 3/3 completos
 [OK] Longitud apropiada (diferencia < 20%)
 [OK] Todas las secciones presentes
 [OK] Todas las plantillas completas
 ...
 Estado: [OK] COMPLETO - Listo para FASE 4
 ...
 **CUÁNDO EJECUTAR:**
 ...
 - [OK] ANTES de considerar el archivo "completado"
 - [OK] ANTES de continuar con el siguiente archivo
...
3. **Comparar secciones:**
 ...
 TRADUCCIÓN:
 +- Cuándo Desviarse de Esta Regla [OK]
 +- Ventajas del Mapeo Directo [ERROR] <- NO EXISTE EN ORIGINAL
...
.. code-block:: text
 ...
 ¿Veo tablas comparativas ([OK]/[ERROR])?
...
.. code-block:: text
 ...
 [OK] TODO el texto original traducido palabra por palabra
 [OK] TODOS los ejemplos incluidos
 [OK] TODAS las explicaciones preservadas
 [OK] TODOS los detalles técnicos mantenidos
 [OK] Longitud esperada: 1.5-3.0x el original

 NO significa:
 [ERROR] Solo estructura y encabezados
 [ERROR] Resumen del contenido
 [ERROR] Parafraseo breve
 [ERROR] Versión abreviada

.. code-block:: text

 "Traducción FIEL" significa:
 [OK] SOLO el contenido que existe en el original
 [OK] Sin agregar secciones nuevas
 [OK] Sin agregar ejemplos propios
 [OK] Sin agregar listas de ventajas/tipos
 [OK] Sin expandir explicaciones

 NO significa:
 [ERROR] "Mejorar" el contenido original
 [ERROR] Agregar información "útil"
 [ERROR] Crear ejemplos "educativos"
 [ERROR] Completar información "faltante"
...
.. code-block:: text
 ...
 [OK] Mantener formato RST
 [OK] Preservar intención del autor

 NO ES TU ROL:
 [ERROR] "Mejorar" el contenido original
 [ERROR] Agregar valor educativo extra
 [ERROR] Expandir explicaciones incompletas
...
**Si TODAS las casillas están [OK]:**

.. code-block:: text

 [OK] Archivo COMPLETADO correctamente
 -> Continuar con siguiente archivo
 -> Aplicar FASE 5.6 al siguiente

**Si ALGUNA casilla está [ERROR]:**

.. code-block:: text

 [ERROR] Archivo NO completado
...
.. code-block:: text
 ...
 [ALERT] Archivo <30 líneas con original >40 líneas
...
.. code-block:: text
 ...
 [ALERT] Estoy escribiendo sección que no veo en original
...
.. code-block:: text
 ...
 [ALERT] Estoy creando code-block que no está en original
...
.. code-block:: text
 ...
 [ALERT] Estoy expandiendo una explicación que parece breve
...
.. code-block:: text
 ...
 VALIDACIÓN FASE 5.6:
 [OK] Longitud: 36 líneas / 20 líneas = 1.8x (RANGO OK)
 [OK] Secciones: Solo las del original
 [OK] Ejemplos: 1 figura (igual que original)
 [OK] Check visual: Sin secciones sospechosas
 [OK] Fidelidad: 100% contenido original, 0% agregados
 [OK] Checklist: Todas las casillas marcadas

 RESULTADO: ARCHIVO VÁLIDO [OK]
...
.. code-block:: bash
 ...
 echo "[ERROR] ERRORES en compilación"
 exit 1
 else
...
[ERROR] **NO** buscar archivos por palabras clave en nombres
[OK] **SÍ** usar la estructura de carpetas del repositorio
...
[OK] Proceso sistemático y repetible
[OK] Checkpoints de calidad en cada fase
[OK] Documentación de decisiones
[OK] Métricas de progreso
[OK] Troubleshooting integrado
