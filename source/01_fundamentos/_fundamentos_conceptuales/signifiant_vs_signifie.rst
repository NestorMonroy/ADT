...
✅ Fidelidad formal máxima  
✅ Rastreable al original  
✅ Útil para estudio comparativo  
✅ Preserva peculiaridades del original

**Desventajas:**

❌ Puede resultar incomprensible  
❌ Puede violar gramática del destino  
❌ Puede sonar "extraño" o "forzado"  
❌ Difícil de leer
...
✅ Natural en el destino  
✅ Fácil de leer/entender  
✅ Funcionalmente equivalente  
✅ Respeta idioma destino

**Desventajas:**

❌ Menos rastreable al original  
❌ Puede perder matices formales  
❌ Requiere más interpretación  
❌ Subjetivo
...
.. code-block:: rst
   ...
   # Preserva: Lista numerada (Signifié) ✅
   # Adapta: Sintaxis natural de RST (Signifiant) ✅
...
- **Signifié preservado:** "Énfasis fuerte" ✅
...
- **Signifié:** "Referencia a sección de introducción" → **Preservado** ✅
...
.. code-block:: rst
   ...
   Signifié preservado: "Párrafo normal" ✅
