...
.. code-block:: rst
   ...
   - Item nivel 1
     - SubItem nivel 2   # ❌ Falta línea vacía
...
.. code-block:: rst
   ...
   - Item nivel 1
     ...
     - SubItem nivel 2   # ✅ Línea vacía + indentación
...
.. code-block:: text
   ...
   Problema: Enriquecimiento insuficiente ❌
...
.. code-block:: text
   ...
   Problema: Enriquecimiento excesivo ❌
...
.. code-block:: text
   ...
   ❌ No aplicar PASO 0 → Omisiones → Re-trabajo
   ❌ No usar MD-002 → Indecisión sobre enriquecimiento
   ❌ No usar MD-004 → Dudar en cada término
   ❌ Perfeccionismo excesivo → Ciclos infinitos
   
   ✅ Solución: Seguir proceso sistemáticamente
...
.. code-block:: text
   ...
   ✅ Complejidad de archivos asignados
...
.. code-block:: text
   ...
   ✅ ≥ 95% = Calidad aprobada
   ⚠️ 85-94% = Revisar y mejorar
   ❌ < 85% = No aprobar, re-hacer
...
.. code-block:: text
   ...
   NO incluir:
   ❌ Solo "no funciona"
   ❌ Screenshots de texto (copiar texto)
   ❌ Proyecto completo (solo archivo problemático)
