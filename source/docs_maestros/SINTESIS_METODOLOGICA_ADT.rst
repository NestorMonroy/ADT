...
.. code-block:: rst
   ...
   **importante**
   ...
   # Preserva: Signifié (énfasis fuerte) ✅
   # Cambia: Signifiant (de \textbf{} a **) ✅
...
.. code-block:: text
   ...
   ├─ METODO_TRADUCCION_PESHITTA_ZACHARIAS ⭐ Base teórica
   ├─ ARQUITECTURA_DOCUMENTAL_TRADUCCION    Aplicación práctica
   └─ SINTESIS_METODOLOGICA_ADT             ⭐ Este documento
...
.. code-block:: text
   ...
   ├─ metodo_segmentacion.rst        ⭐ NUEVO: De Peshitta
   └─ objetivos_tacticas.rst         ⭐ NUEVO: 4 objetivos, 14+ tácticas
