...
.. code-block:: text
   ...
   ├── make.bat              ✅ Batch de compilación (Windows)
   ├── build/                ✅ Salida compilada (HTML)
   ├── source/               ✅ TODO EL CONTENIDO DOCUMENTAL
...
.. code-block:: text
   ...
   │
   ├── 01_fundamentos/            ✅ Contenido documental
   ├── 02_procedimientos/         ✅ Contenido documental
   ├── ...                        ✅ Contenido documental
   ├── 10_apendices/              ✅ Contenido documental
   │
   ├── biblioteca/                ✅ Contenido documental
   ├── diataxis/                  ✅ Contenido documental
   ├── docs/                      ✅ Contenido documental
   └── docs_maestros/             ✅ Contenido documental
