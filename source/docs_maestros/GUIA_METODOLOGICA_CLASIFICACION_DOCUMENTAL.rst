...
.. code-block:: rst
   ...
   ✅ Números correlativos: 001, 002, 003, ...
   ✅ Sin saltos: No usar 001, 005, 010
...
.. code-block:: text
   ...
   Libro_Ejemplo/
   │
   ├── metadata_libro.rst              # ⭐ Información bibliográfica
   ├── index.rst                       # ⭐ Índice del libro completo
   ├── glosario_acumulativo.rst        # ⭐ Todos los términos del libro
   │
...
.. code-block:: rst
   ...
   ✅ metadata_libro.rst     → Información bibliográfica + código clasificación
   ✅ index.rst              → Índice navegable del libro
   ✅ glosario_acumulativo.rst → Glosario completo del libro
   
   Opcional pero recomendado:
   ⚠️ glosario_capitulo.rst (por capítulo)
   ⚠️ notas_traduccion.rst (por capítulo)
...
4. **Evitar ambigüedades:**
   ...
   .. code-block:: text
      ...
      ❌ MAT para "Material Design" (ya es Matemáticas)
      ✅ MDG para "Material Design"
...
.. code-block:: rst
   ...
   Capítulos Completados
      ✅ [Listado de capítulos completados]
   
   Capítulos En Proceso
      🔄 [Listado de capítulos en proceso con %]
   
   Capítulos Pendientes
      ⏳ [Listado de capítulos pendientes]
...
.. code-block:: rst
   ...
   ⚠️ Público Objetivo
   ⚠️ Palabras Clave
   ⚠️ Traductor Principal
   ⚠️ Términos en Glosario
   ⚠️ Procedimientos Aplicados

**Campos OPCIONALES:**

.. code-block:: rst

   ℹ️ Revisores Técnicos
   ℹ️ Especialistas Consultados
   ℹ️ Figuras (estadísticas)
   ℹ️ Tablas (estadísticas)
   ℹ️ Repositorio Original
   ℹ️ Notas Especiales
   ℹ️ Referencias Cruzadas
...
.. code-block:: rst
   ...
   ✅ Aparecen 3+ libros del mismo tema sin especialidad adecuada
   ✅ Tecnología emergente con momentum (ej: "Svelte" si hay demanda)
   ✅ Área de conocimiento bien delimitada
   
   NO AGREGAR cuando:
   ❌ Solo 1 libro (usar especialidad general o más cercana)
   ❌ Tecnología muy nicho o temporal
   ❌ Puede clasificarse en especialidad existente
...
.. code-block:: rst
   ...
   ⚠️ EVITAR reclasificaciones frecuentes
...
.. code-block:: rst
   ...
   ✅ ORGANIZACIÓN: Estructura lógica y escalable
   ✅ CONSISTENCIA: Dos traductores clasifican igual
   ✅ BÚSQUEDA: Localización rápida por código o navegación
   ✅ ESCALABILIDAD: Soporta crecimiento ilimitado
   ✅ INTEROPERABILIDAD: Integración con sistemas externos
   ✅ PROFESIONALISMO: Base sólida para biblioteca técnica
