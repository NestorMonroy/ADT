---
name: bash-production-scripting
description: "Best practices para bash scripts production-grade con compatibilidad cross-platform. Usar cuando: necesitas crear scripts robustos, automatizar builds, scripting portable (Linux/macOS/Git Bash), o garantizar manejo de errores explícito."
version: 1.1.0
created: 2026-01-31
updated: 2026-02-01
---
...
## Decision Framework: ¿Cuándo Usar Scripting de Producción?

**Usa este framework para decidir nivel de rigor necesario**:

1. **¿El script se ejecutará en producción o build automation?**
   → Sí, usar TODAS las best practices de este skill

2. **¿Necesita funcionar en múltiples plataformas (Linux/macOS/Git Bash)?**
   → Sí, seguir patrones cross-platform estrictamente

3. **¿Los errores deben ser explícitos y rastreables?**
   → Sí, usar error handling robusto con logging

4. **¿Es script one-off temporal o experimental?**
   → No necesitas TODAS las best practices (pero algunas sí)

5. **¿Otras personas ejecutarán este script?**
   → Sí, documentación y error messages claros obligatorios

6. **¿El script modifica archivos o estado importante?**
   → Sí, error handling crítico + dry-run mode

7. **¿No estás seguro del nivel de rigor?**
   → Aplicar best practices (más seguro)

**Regla de oro**: **Producción O crítico → aplicar skill completo**
...
### Señales Explícitas
- Usuario dice: "necesito script de build"
- Usuario dice: "automatizar [proceso]"
- Usuario menciona: "producción", "CI/CD", "automation"
- Usuario pregunta: "¿cómo escribo script robusto?"

### Señales Implícitas
- Script que se ejecutará repetidamente
- Necesita logging para debugging
- Múltiples entornos (dev/staging/prod)
- Usuario menciona cross-platform
- Contexto indica script permanente (no temporal)

### Trigger Words
- "script", "bash", "automation", "build"
- "producción", "robusto", "portable"
- "cross-platform", "Linux", "macOS", "Git Bash"
- "error handling", "logging"

**Anti-triggers** (NO necesitas este skill):
- Script interactivo simple
- One-liner temporal
- Experimentación rápida
- Script que solo tú usarás una vez

---

## Self-Check Before Scripting

**OBLIGATORIO antes de escribir script de producción**:

### Pre-Scripting Checks
- [ ] ¿El script es crítico o se usará en producción?
- [ ] ¿Necesita ser cross-platform compatible?
- [ ] ¿Tengo tiempo para hacerlo correctamente?
- [ ] ¿Entiendo los core principles de este skill?

**Si NO a todo → Script simple está bien**

### During Scripting Checks
- [ ] ¿Uso funciones puras con local variables?
- [ ] ¿Manejo errores explícitamente (set -euo pipefail)?
- [ ] ¿Salida es ASCII-safe (no ANSI codes en logs)?
- [ ] ¿Funciona en Git Bash/MINGW (no bashisms)?
- [ ] ¿Logs son informativos y útiles?

**Si NO en alguno → PAUSE - Corregir antes de continuar**

### Post-Scripting Checks
- [ ] ¿Probé en Git Bash/Linux/macOS?
- [ ] ¿Tiene logging apropiado para debugging?
- [ ] ¿Errores son informativos (no "Error" genérico)?
- [ ] ¿Script es mantenible y entendible?
- [ ] ¿Documenté uso y parámetros?

**Si NO → COMPLETAR antes de deployar**
...
✅ **Frontmatter YAML agregado**
- Migrado de formato libre a YAML estándar
- Consistencia con otros skills del proyecto

✅ **Decision Framework** - ¿Cuándo Usar Scripting de Producción?
- 7 preguntas para decidir nivel de rigor necesario
- Regla de oro: "Producción O crítico → aplicar skill completo"
- Diferencia entre scripts de producción vs temporales

✅ **Trigger Patterns** - Cuándo aplicar best practices
- Señales explícitas (usuario dice "script de build")
- Señales implícitas (producción, CI/CD, automation)
- Anti-triggers para scripts simples/temporales

✅ **Self-Check Mechanisms** - Calidad de scripting
- Pre-Scripting (nivel de rigor necesario)
- During Scripting (pure functions, error handling, ASCII-safe)
- Post-Scripting (testing cross-platform, logging, documentación)

**Líneas agregadas**: ~90 líneas + YAML frontmatter

**Beneficio principal**:
- Usuarios deciden cuándo aplicar best practices completas
- Scripts críticos siguen patrones robustos
- Scripts simples no over-engineered

### v1.0.0 - 2026-01-31
- Versión inicial
- Best practices de bash production
- Patrones cross-platform (Linux/macOS/Git Bash)
